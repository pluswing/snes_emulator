...
pub static CPU_OPS_CODES: Lazy<HashMap<u8, OpCode>> = Lazy::new(|| {
  ...
  m.insert(0x65, OpCode::new(0x65, "ADC", 2, 3, CycleCalcMode::None, AddressingMode::Direct_Page));
  m.insert(0x75, OpCode::new(0x75, "ADC", 2, 4, CycleCalcMode::None, AddressingMode::Direct_Page_Indexed_by_X));
  m.insert(0x6D, OpCode::new(0x6D, "ADC", 3, 4, CycleCalcMode::None, AddressingMode::Absolute));
  m.insert(0x7D, OpCode::new(0x7D, "ADC", 3, 4, CycleCalcMode::Page, AddressingMode::Absolute_Indexed_by_X));
  m.insert(0x79, OpCode::new(0x79, "ADC", 3, 4, CycleCalcMode::Page, AddressingMode::Absolute_Indexed_by_Y));
  ...
  m.insert(0x25, OpCode::new(0x25, "AND", 2, 3, CycleCalcMode::None, AddressingMode::Direct_Page));
  m.insert(0x35, OpCode::new(0x35, "AND", 2, 4, CycleCalcMode::None, AddressingMode::Direct_Page_Indexed_by_X));
  m.insert(0x2D, OpCode::new(0x2D, "AND", 3, 4, CycleCalcMode::None, AddressingMode::Absolute));
  m.insert(0x3D, OpCode::new(0x3D, "AND", 3, 4, CycleCalcMode::Page, AddressingMode::Absolute_Indexed_by_X));
  m.insert(0x39, OpCode::new(0x39, "AND", 3, 4, CycleCalcMode::Page, AddressingMode::Absolute_Indexed_by_Y));
  ...
  m.insert(0x06, OpCode::new(0x06, "ASL", 2, 5, CycleCalcMode::None, AddressingMode::Direct_Page));
  m.insert(0x16, OpCode::new(0x16, "ASL", 2, 6, CycleCalcMode::None, AddressingMode::Direct_Page_Indexed_by_X));
  m.insert(0x0E, OpCode::new(0x0E, "ASL", 3, 6, CycleCalcMode::None, AddressingMode::Absolute));
  m.insert(0x1E, OpCode::new(0x1E, "ASL", 3, 7, CycleCalcMode::None, AddressingMode::Absolute_Indexed_by_X));
  ...
  m.insert(0x24, OpCode::new(0x24, "BIT", 2, 3, CycleCalcMode::None, AddressingMode::Direct_Page));
  ...
  m.insert(0xC5, OpCode::new(0xC5, "CMP", 2, 3, CycleCalcMode::None, AddressingMode::Direct_Page));
  m.insert(0xD5, OpCode::new(0xD5, "CMP", 2, 4, CycleCalcMode::None, AddressingMode::Direct_Page_Indexed_by_X));
  m.insert(0xCD, OpCode::new(0xCD, "CMP", 3, 4, CycleCalcMode::None, AddressingMode::Absolute));
  m.insert(0xDD, OpCode::new(0xDD, "CMP", 3, 4, CycleCalcMode::Page, AddressingMode::Absolute_Indexed_by_X));
  m.insert(0xD9, OpCode::new(0xD9, "CMP", 3, 4, CycleCalcMode::Page, AddressingMode::Absolute_Indexed_by_Y));
  ...
  m.insert(0xE4, OpCode::new(0xE4, "CPX", 2, 3, CycleCalcMode::None, AddressingMode::Direct_Page));
  ...
  m.insert(0xC4, OpCode::new(0xC4, "CPY", 2, 3, CycleCalcMode::None, AddressingMode::Direct_Page));
  m.insert(0xCC, OpCode::new(0xCC, "CPY", 3, 4, CycleCalcMode::None, AddressingMode::Absolute));
  m.insert(0xC6, OpCode::new(0xC6, "DEC", 2, 5, CycleCalcMode::None, AddressingMode::Direct_Page));
  m.insert(0xD6, OpCode::new(0xD6, "DEC", 2, 6, CycleCalcMode::None, AddressingMode::Direct_Page_Indexed_by_X));
  m.insert(0xCE, OpCode::new(0xCE, "DEC", 3, 6, CycleCalcMode::None, AddressingMode::Absolute));
  m.insert(0xDE, OpCode::new(0xDE, "DEC", 3, 7, CycleCalcMode::None, AddressingMode::Absolute_Indexed_by_X));
  ...
  m.insert(0x45, OpCode::new(0x45, "EOR", 2, 3, CycleCalcMode::None, AddressingMode::Direct_Page));
  m.insert(0x55, OpCode::new(0x55, "EOR", 2, 4, CycleCalcMode::None, AddressingMode::Direct_Page_Indexed_by_X));
  m.insert(0x4D, OpCode::new(0x4D, "EOR", 3, 4, CycleCalcMode::None, AddressingMode::Absolute));
  m.insert(0x5D, OpCode::new(0x5D, "EOR", 3, 4, CycleCalcMode::Page, AddressingMode::Absolute_Indexed_by_X));
  m.insert(0x59, OpCode::new(0x59, "EOR", 3, 4, CycleCalcMode::Page, AddressingMode::Absolute_Indexed_by_Y));
  ...
  m.insert(0xE6, OpCode::new(0xE6, "INC", 2, 5, CycleCalcMode::None, AddressingMode::Direct_Page));
  m.insert(0xF6, OpCode::new(0xF6, "INC", 2, 6, CycleCalcMode::None, AddressingMode::Direct_Page_Indexed_by_X));
  m.insert(0xEE, OpCode::new(0xEE, "INC", 3, 6, CycleCalcMode::None, AddressingMode::Absolute));
  m.insert(0xFE, OpCode::new(0xFE, "INC", 3, 7, CycleCalcMode::None, AddressingMode::Absolute_Indexed_by_X));
  ...
  m.insert(0xA5, OpCode::new(0xA5, "LDA", 2, 3, CycleCalcMode::None, AddressingMode::Direct_Page));
  m.insert(0xB5, OpCode::new(0xB5, "LDA", 2, 4, CycleCalcMode::None, AddressingMode::Direct_Page_Indexed_by_X));
  m.insert(0xAD, OpCode::new(0xAD, "LDA", 3, 4, CycleCalcMode::None, AddressingMode::Absolute));
  m.insert(0xBD, OpCode::new(0xBD, "LDA", 3, 4, CycleCalcMode::Page, AddressingMode::Absolute_Indexed_by_X));
  ...
  m.insert(0xA4, OpCode::new(0xA4, "LDY", 2, 3, CycleCalcMode::None, AddressingMode::Direct_Page));
  m.insert(0xB4, OpCode::new(0xB4, "LDY", 2, 4, CycleCalcMode::None, AddressingMode::Direct_Page_Indexed_by_X));
  m.insert(0xAC, OpCode::new(0xAC, "LDY", 3, 4, CycleCalcMode::None, AddressingMode::Absolute));
  m.insert(0xBC, OpCode::new(0xBC, "LDY", 3, 4, CycleCalcMode::Page, AddressingMode::Absolute_Indexed_by_X));
  m.insert(0x4A, OpCode::new(0x4A, "LSR", 1, 2, CycleCalcMode::None, AddressingMode::Accumulator));
  m.insert(0x46, OpCode::new(0x46, "LSR", 2, 5, CycleCalcMode::None, AddressingMode::Direct_Page));
  m.insert(0x56, OpCode::new(0x56, "LSR", 2, 6, CycleCalcMode::None, AddressingMode::Direct_Page_Indexed_by_X));
  m.insert(0x4E, OpCode::new(0x4E, "LSR", 3, 6, CycleCalcMode::None, AddressingMode::Absolute));
  m.insert(0x5E, OpCode::new(0x5E, "LSR", 3, 7, CycleCalcMode::None, AddressingMode::Absolute_Indexed_by_X));
  ...
  m.insert(0x05, OpCode::new(0x05, "ORA", 2, 3, CycleCalcMode::None, AddressingMode::Direct_Page));
  m.insert(0x15, OpCode::new(0x15, "ORA", 2, 4, CycleCalcMode::None, AddressingMode::Direct_Page_Indexed_by_X));
  m.insert(0x0D, OpCode::new(0x0D, "ORA", 3, 4, CycleCalcMode::None, AddressingMode::Absolute));
  m.insert(0x1D, OpCode::new(0x1D, "ORA", 3, 4, CycleCalcMode::Page, AddressingMode::Absolute_Indexed_by_X));
  m.insert(0x19, OpCode::new(0x19, "ORA", 3, 4, CycleCalcMode::Page, AddressingMode::Absolute_Indexed_by_Y));
  ...
  m.insert(0x26, OpCode::new(0x26, "ROL", 2, 5, CycleCalcMode::None, AddressingMode::Direct_Page));
  m.insert(0x36, OpCode::new(0x36, "ROL", 2, 6, CycleCalcMode::None, AddressingMode::Direct_Page_Indexed_by_X));
  m.insert(0x2E, OpCode::new(0x2E, "ROL", 3, 6, CycleCalcMode::None, AddressingMode::Absolute));
  m.insert(0x3E, OpCode::new(0x3E, "ROL", 3, 7, CycleCalcMode::None, AddressingMode::Absolute_Indexed_by_X));
  m.insert(0x6A, OpCode::new(0x6A, "ROR", 1, 2, CycleCalcMode::None, AddressingMode::Accumulator));
  m.insert(0x66, OpCode::new(0x66, "ROR", 2, 5, CycleCalcMode::None, AddressingMode::Direct_Page));
  m.insert(0x76, OpCode::new(0x76, "ROR", 2, 6, CycleCalcMode::None, AddressingMode::Direct_Page_Indexed_by_X));
  m.insert(0x6E, OpCode::new(0x6E, "ROR", 3, 6, CycleCalcMode::None, AddressingMode::Absolute));
  m.insert(0x7E, OpCode::new(0x7E, "ROR", 3, 7, CycleCalcMode::None, AddressingMode::Absolute_Indexed_by_X));
  ...
  m.insert(0xE5, OpCode::new(0xE5, "SBC", 2, 3, CycleCalcMode::None, AddressingMode::Direct_Page));
  m.insert(0xF5, OpCode::new(0xF5, "SBC", 2, 4, CycleCalcMode::None, AddressingMode::Direct_Page_Indexed_by_X));
  m.insert(0xED, OpCode::new(0xED, "SBC", 3, 4, CycleCalcMode::None, AddressingMode::Absolute));
  m.insert(0xFD, OpCode::new(0xFD, "SBC", 3, 4, CycleCalcMode::Page, AddressingMode::Absolute_Indexed_by_X));
  m.insert(0xF9, OpCode::new(0xF9, "SBC", 3, 4, CycleCalcMode::Page, AddressingMode::Absolute_Indexed_by_Y));
  ...
  m.insert(0x85, OpCode::new(0x85, "STA", 2, 3, CycleCalcMode::None, AddressingMode::Direct_Page));
  m.insert(0x95, OpCode::new(0x95, "STA", 2, 4, CycleCalcMode::None, AddressingMode::Direct_Page_Indexed_by_X));
  m.insert(0x8D, OpCode::new(0x8D, "STA", 3, 4, CycleCalcMode::None, AddressingMode::Absolute));
  m.insert(0x9D, OpCode::new(0x9D, "STA", 3, 5, CycleCalcMode::None, AddressingMode::Absolute_Indexed_by_X));
  m.insert(0x99, OpCode::new(0x99, "STA", 3, 5, CycleCalcMode::None, AddressingMode::Absolute_Indexed_by_Y));
  ...
  m.insert(0x9F, OpCode::new(0x9F, "*SHA", 3, 5, CycleCalcMode::None, AddressingMode::Absolute_Indexed_by_Y));
  ...
  m.insert(0xC7, OpCode::new(0xC7, "*DCP", 2, 5, CycleCalcMode::None, AddressingMode::Direct_Page));
  m.insert(0xD7, OpCode::new(0xD7, "*DCP", 2, 6, CycleCalcMode::None, AddressingMode::Direct_Page_Indexed_by_X));
  m.insert(0xCF, OpCode::new(0xCF, "*DCP", 3, 6, CycleCalcMode::None, AddressingMode::Absolute));
  m.insert(0xDF, OpCode::new(0xDF, "*DCP", 3, 7, CycleCalcMode::None, AddressingMode::Absolute_Indexed_by_X));
  m.insert(0xDB, OpCode::new(0xDB, "*DCP", 3, 7, CycleCalcMode::None, AddressingMode::Absolute_Indexed_by_Y));
  ...
  m.insert(0x04, OpCode::new(0x04, "*NOP", 2, 3, CycleCalcMode::None, AddressingMode::Direct_Page));
  m.insert(0x14, OpCode::new(0x14, "*NOP", 2, 4, CycleCalcMode::None, AddressingMode::Direct_Page_Indexed_by_X));
  m.insert(0x34, OpCode::new(0x34, "*NOP", 2, 4, CycleCalcMode::None, AddressingMode::Direct_Page_Indexed_by_X));
  m.insert(0x44, OpCode::new(0x44, "*NOP", 2, 3, CycleCalcMode::None, AddressingMode::Direct_Page));
  m.insert(0x54, OpCode::new(0x54, "*NOP", 2, 4, CycleCalcMode::None, AddressingMode::Direct_Page_Indexed_by_X));
  m.insert(0x64, OpCode::new(0x64, "*NOP", 2, 3, CycleCalcMode::None, AddressingMode::Direct_Page));
  m.insert(0x74, OpCode::new(0x74, "*NOP", 2, 4, CycleCalcMode::None, AddressingMode::Direct_Page_Indexed_by_X));
  ...
  m.insert(0xD4, OpCode::new(0xD4, "*NOP", 2, 4, CycleCalcMode::None, AddressingMode::Direct_Page_Indexed_by_X));
  m.insert(0xE2, OpCode::new(0xE2, "*NOP", 2, 2, CycleCalcMode::None, AddressingMode::Immediate));
  m.insert(0xF4, OpCode::new(0xF4, "*NOP", 2, 4, CycleCalcMode::None, AddressingMode::Direct_Page_Indexed_by_X));
  m.insert(0xE7, OpCode::new(0xE7, "*ISB", 2, 5, CycleCalcMode::None, AddressingMode::Direct_Page));
  m.insert(0xF7, OpCode::new(0xF7, "*ISB", 2, 6, CycleCalcMode::None, AddressingMode::Direct_Page_Indexed_by_X));
  m.insert(0xEF, OpCode::new(0xEF, "*ISB", 3, 6, CycleCalcMode::None, AddressingMode::Absolute));
  m.insert(0xFF, OpCode::new(0xFF, "*ISB", 3, 7, CycleCalcMode::None, AddressingMode::Absolute_Indexed_by_X));
  m.insert(0xFB, OpCode::new(0xFB, "*ISB", 3, 7, CycleCalcMode::None, AddressingMode::Absolute_Indexed_by_Y));
  ...
  m.insert(0x27, OpCode::new(0x27, "*RLA", 2, 5, CycleCalcMode::None, AddressingMode::Direct_Page));
  m.insert(0x37, OpCode::new(0x37, "*RLA", 2, 6, CycleCalcMode::None, AddressingMode::Direct_Page_Indexed_by_X));
  m.insert(0x2F, OpCode::new(0x2F, "*RLA", 3, 6, CycleCalcMode::None, AddressingMode::Absolute));
  m.insert(0x3F, OpCode::new(0x3F, "*RLA", 3, 7, CycleCalcMode::None, AddressingMode::Absolute_Indexed_by_X));
  m.insert(0x3B, OpCode::new(0x3B, "*RLA", 3, 7, CycleCalcMode::None, AddressingMode::Absolute_Indexed_by_Y));
  ...
  m.insert(0x67, OpCode::new(0x67, "*RRA", 2, 5, CycleCalcMode::None, AddressingMode::Direct_Page));
  m.insert(0x77, OpCode::new(0x77, "*RRA", 2, 6, CycleCalcMode::None, AddressingMode::Direct_Page_Indexed_by_X));
  m.insert(0x6F, OpCode::new(0x6F, "*RRA", 3, 6, CycleCalcMode::None, AddressingMode::Absolute));
  m.insert(0x7F, OpCode::new(0x7F, "*RRA", 3, 7, CycleCalcMode::None, AddressingMode::Absolute_Indexed_by_X));
  m.insert(0x7B, OpCode::new(0x7B, "*RRA", 3, 7, CycleCalcMode::None, AddressingMode::Absolute_Indexed_by_Y));
  ...
  m.insert(0x07, OpCode::new(0x07, "*SLO", 2, 5, CycleCalcMode::None, AddressingMode::Direct_Page));
  m.insert(0x17, OpCode::new(0x17, "*SLO", 2, 6, CycleCalcMode::None, AddressingMode::Direct_Page_Indexed_by_X));
  m.insert(0x0F, OpCode::new(0x0F, "*SLO", 3, 6, CycleCalcMode::None, AddressingMode::Absolute));
  m.insert(0x1F, OpCode::new(0x1F, "*SLO", 3, 7, CycleCalcMode::None, AddressingMode::Absolute_Indexed_by_X));
  m.insert(0x1B, OpCode::new(0x1B, "*SLO", 3, 7, CycleCalcMode::None, AddressingMode::Absolute_Indexed_by_Y));
  ...
  m.insert(0x47, OpCode::new(0x47, "*SRE", 2, 5, CycleCalcMode::None, AddressingMode::Direct_Page));
  m.insert(0x57, OpCode::new(0x57, "*SRE", 2, 6, CycleCalcMode::None, AddressingMode::Direct_Page_Indexed_by_X));
  m.insert(0x4F, OpCode::new(0x4F, "*SRE", 3, 6, CycleCalcMode::None, AddressingMode::Absolute));
  m.insert(0x5F, OpCode::new(0x5F, "*SRE", 3, 7, CycleCalcMode::None, AddressingMode::Absolute_Indexed_by_X));
  m.insert(0x5B, OpCode::new(0x5B, "*SRE", 3, 7, CycleCalcMode::None, AddressingMode::Absolute_Indexed_by_Y));
  ...
  m.insert(0x9E, OpCode::new(0x9E, "*SHX", 3, 5, CycleCalcMode::None, AddressingMode::Absolute_Indexed_by_Y));
  m.insert(0x9C, OpCode::new(0x9C, "*SHY", 3, 5, CycleCalcMode::None, AddressingMode::Absolute_Indexed_by_X));
  m.insert(0x0C, OpCode::new(0x0C, "*NOP", 3, 4, CycleCalcMode::None, AddressingMode::Absolute));
  m.insert(0x1C, OpCode::new(0x1C, "*NOP", 3, 4, CycleCalcMode::Page, AddressingMode::Absolute_Indexed_by_X));
  m.insert(0x3C, OpCode::new(0x3C, "*NOP", 3, 4, CycleCalcMode::Page, AddressingMode::Absolute_Indexed_by_X));
  m.insert(0x5C, OpCode::new(0x5C, "*NOP", 3, 4, CycleCalcMode::Page, AddressingMode::Absolute_Indexed_by_X));
  m.insert(0x7C, OpCode::new(0x7C, "*NOP", 3, 4, CycleCalcMode::Page, AddressingMode::Absolute_Indexed_by_X));
  m.insert(0xDC, OpCode::new(0xDC, "*NOP", 3, 4, CycleCalcMode::Page, AddressingMode::Absolute_Indexed_by_X));
  ...
  m.insert(0xA7, OpCode::new(0xA7, "LDA", 2, 6, CycleCalcMode::None, AddressingMode::Direct_Page_Indirect_Long));
  m.insert(0xBF, OpCode::new(0xBF, "LDA", 4, 5, CycleCalcMode::None, AddressingMode::Absolute_Long_Indexed_by_X));

  // m.insert(0xA1, OpCode::new(0xA1, "LDA", 2, 6, CycleCalcMode::None, AddressingMode::Indirect_X));
  m.insert(0xA1, OpCode::new(0xA1, "LDA", 2, 6, CycleCalcMode::None, AddressingMode::Direct_Page_Indexed_Indirect_by_X));

  // m.insert(0xB1, OpCode::new(0xB1, "LDA", 2, 5, CycleCalcMode::Page, AddressingMode::Indirect_Y));
  m.insert(0xB1, OpCode::new(0xB1, "LDA", 2, 5, CycleCalcMode::Page, AddressingMode::Direct_Page_Indirect_Indexed_by_Y));
  m
});
